...
describe('Testing ./index.js', () => {
    test('Testing compress()', async () => {
        ...
        let response = await cliManager.compress('./force-app/main/default/applications/app_service_console.app-meta.xml', undefined);
        response = await cliManager.compress('./force-app/main/default/applications', undefined);
        response = await cliManager.compress(['./force-app/main/default/applications/app_service_console.app-meta.xml', './force-app/main/default/applications/Graphics_Pack.app-meta.xml'], undefined);
    ...
    test('Testing compress() SFDX', async () => {
        const cliManager = new CLIManager('./src/test/assets/SFDXProject', 50);
        cliManager.setApiVersion(50);
        ...
        let response = await cliManager.compress('./force-app/main/default/applications/app_service_console.app-meta.xml', undefined);
        response = await cliManager.compress('./force-app/main/default/applications', undefined);
        response = await cliManager.compress(['./force-app/main/default/applications/app_service_console.app-meta.xml', './src/test/assets/SFDXProject/force-app/main/default/applications/Graphics_Pack.app-meta.xml'], undefined);
        cliManager.abortProcess();
    }, 30000);
    test('Testing compareWithOrg() SFDX', async () => {
        const cliManager = new CLIManager('./src/test/assets/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing compareOrgBetween() SFDX', async () => {
        const cliManager = new CLIManager('./src/test/assets/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing retrieveOrgSpecialMetadata() SFDX', async () => {
        const cliManager = new CLIManager('./src/test/assets/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing retrieveLocalSpecialMetadata() SFDX', async () => {
        const cliManager = new CLIManager('./src/test/assets/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing retrieveMixedSpecialMetadata() SFDX', async () => {
        const cliManager = new CLIManager('./src/test/assets/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing loadUserPermissions() SFDX', async () => {
        const cliManager = new CLIManager('./src/test/assets/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing ignoreMetadata() SFDX', async () => {
        const cliManager = new CLIManager('./src/test/assets/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing isAuraHelperCLIInstalled() SFDX', async () => {
        const cliManager = new CLIManager('./src/test/assets/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing getAuraHelperCLIVersion() SFDX', async () => {
        const cliManager = new CLIManager('./src/test/assets/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing describeLocalMetadata() SFDX', async () => {
        const cliManager = new CLIManager('../gitTest/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing describeOrgMetadata() SFDX', async () => {
        const cliManager = new CLIManager('../gitTest/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing createPackageFromGit() SFDX', async () => {
        const cliManager = new CLIManager('../gitTest/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing createPackageFromJSON() SFDX', async () => {
        const cliManager = new CLIManager('./src/test/assets/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
    ...
    test('Testing createPackageFromOtherPackages() SFDX', async () => {
        const cliManager = new CLIManager('./src/test/assets/SFDXProject', 50);
        cliManager.setApiVersion(50);
        cliManager.setNamespacePrefix('');
        cliManager.useAuraHelperSFDX();
